...
\titlegraphic{
  ...
  \hfill\includegraphics[height=3.1cm]{images/illustration_borderless.png}
}
...
\input{parties_oral/intro.tex}
\input{parties_oral/approches.tex}
\input{parties_oral/algo_distance.tex}
\input{parties_oral/markov.tex}
\input{parties_oral/implem.tex}
\input{parties_oral/conclusion.tex}
