...
\annotation{introduire le diagramme uml en le citant}
...
La plus grosse difficulté de l'interface graphique a été la communication de \langage{Rust} et \langage{Python}.\\
...
Grâce à toute cette installation, l'application est plus facile d'accès grâce à une icône dans la barre des tâches par exemple.
...
Ce projet est donc été une véritable opportunité pour mettre en pratique les compétences que nous avons acquises durant nos deux premières années en CMI informatique et de développer de nouvelles compétences et de découvrir un domaine que nous n'avions jamais abordé auparavant. \\
