...
\usepackage{tocloft}
\setlength{\cftbeforetoctitleskip}{1cm}  % Ajuste l'espace avant le titre de la table des matières
\setlength{\cftaftertoctitleskip}{0.5cm} % Réduit ou supprime l'espace après le titre
...
\subsubsection{Récupération des évenements clavier}
...
\subsubsection{Arrêt propre du programme}
