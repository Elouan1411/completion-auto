...
\begin{figure}[H]
	\begin{center}
		{\includegraphics[height=0.45\textwidth]{latex-images/levenshtein.png}}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		{\includegraphics[height=0.45\textwidth]{latex-images/damerau-levenshtein.png}}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		{\includegraphics[height=0.4\textwidth]{latex-images/hamming.png}}
	\end{center}
